# =============================================================================
# COMPLETE VIDEO PROCESSING PIPELINE (LOCAL FILE SUPPORT)
# =============================================================================
...
# Modified to support local video files instead of YouTube URLs.
# =============================================================================
...
print("🎯 VIDEO PROCESSING WITH EXTENDED OLLAMA TIMEOUTS (LOCAL FILE)")
print("=" * 70)
...
# =============================================================================
# 🚨 CONFIGURE YOUR LOCAL VIDEO PATH HERE 🚨
# =============================================================================
# Provide the absolute path to the video file in your Google Drive or Colab environment.
# Example: "/content/drive/MyDrive/my_project/videos/my_video.mp4"
LOCAL_VIDEO_PATH = "/content/drive/MyDrive/my_project/videos/test_video.mp4" 
# =============================================================================
...
class ExtendedYouTubePipeline:
    ...
    def create_processing_task(self):
        ...
        if not os.path.exists(LOCAL_VIDEO_PATH):
            print(f"❌ Error: Local video file not found at: {LOCAL_VIDEO_PATH}")
            print("Please update the LOCAL_VIDEO_PATH variable in the script with a valid path.")
            return None
        ...
        try:
            print(f"📹 Processing video: {LOCAL_VIDEO_PATH}")
            response = requests.post(
    ...
    def run_extended_pipeline(self):
        ...
        print("🎯 STARTING VIDEO PROCESSING WITH EXTENDED TIMEOUTS")
